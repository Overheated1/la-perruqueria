...
export function WhatsAppButton({ phoneNumber, dictionary }: WhatsAppButtonProps) {
          ...
          <AnimatePresence>
            {showTooltip && (
              <motion.div
                ...
                className="absolute bottom-full right-0 mb-2 bg-white rounded-lg shadow-lg p-3 w-64"
              >
                <button
                ...
                {/* <p className="text-sm font-medium mb-1">{dictionary.tooltipTitle}</p> */}
                {/* <p className="text-xs text-gray-600">{dictionary.tooltipDescription}</p> */}
              </motion.div>
            )}
          </AnimatePresence>
        </motion.div>
